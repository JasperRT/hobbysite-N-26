# Generated by Django 5.0.3 on 2024-05-13 03:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('AVAIL', 'Available'), ('SALE', 'On Sale'), ('OUT', 'Out of Stock')], default='AVAIL', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('CART', 'On Cart'), ('TPAY', 'To Pay'), ('TSHIP', 'To Ship'), ('TRECEIVE', 'To Receive'), ('DELIVER', 'Delivered')], max_length=20)),
